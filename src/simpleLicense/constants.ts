...
export const API_ENDPOINT_ADMIN_USERS_RESET_PASSWORD = '/api/v1/admin/users'
export const API_ENDPOINT_ADMIN_USERS_RESET_PASSWORD_SUFFIX = '/reset-password'
export const API_ENDPOINT_ADMIN_USERS_SET_SERVICE_PASSWORD = '/api/v1/admin/users'
export const API_ENDPOINT_ADMIN_USERS_SET_SERVICE_PASSWORD_SUFFIX = '/set-service-password'
...
export const API_ENDPOINT_ADMIN_HEALTH_SNAPSHOT = '/api/v1/admin/health-snapshot'
...
export const ERROR_CODE_UPLOAD_TIMEOUT = 'UPLOAD_TIMEOUT'
...
export const RELEASE_UPLOAD_REQUEST_TIMEOUT_MS = 180_000
