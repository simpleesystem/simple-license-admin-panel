...
export const UI_RELEASE_DIAGNOSTICS_BUTTON = 'Diagnostics' as const
export const UI_RELEASE_DIAGNOSTICS_TITLE = 'Release storage diagnostics' as const
export const UI_RELEASE_DIAGNOSTICS_CLOSE = 'Close' as const
export const UI_RELEASE_DIAGNOSTICS_LOADING = 'Checking release storage keys…' as const
export const UI_RELEASE_DIAGNOSTICS_ERROR = 'Unable to load release diagnostics. Please retry.' as const
export const UI_RELEASE_DIAGNOSTICS_EMPTY = 'No diagnostics available for this product yet.' as const
export const UI_RELEASE_DIAGNOSTICS_COLUMN_VERSION = 'Version' as const
export const UI_RELEASE_DIAGNOSTICS_COLUMN_FILE = 'File' as const
export const UI_RELEASE_DIAGNOSTICS_COLUMN_PRESENT = 'Present' as const
export const UI_RELEASE_DIAGNOSTICS_COLUMN_RESOLVED_KEY = 'Resolved key' as const
