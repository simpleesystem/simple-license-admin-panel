...
export const UI_NAV_ID_DASHBOARD = 'nav-dashboard'
export const UI_NAV_ID_LICENSES = 'nav-licenses'
export const UI_NAV_ID_PRODUCTS = 'nav-products'
export const UI_NAV_ID_TENANTS = 'nav-tenants'
export const UI_NAV_ID_USERS = 'nav-users'
export const UI_NAV_ID_ANALYTICS = 'nav-analytics'
export const UI_NAV_ID_HEALTH = 'nav-health'
export const UI_NAV_ID_AUDIT = 'nav-audit'
export const UI_NAV_LABEL_DASHBOARD = 'Dashboard'
export const UI_NAV_LABEL_LICENSES = 'Licenses'
export const UI_NAV_LABEL_PRODUCTS = 'Products'
export const UI_NAV_LABEL_TENANTS = 'Tenants'
export const UI_NAV_LABEL_USERS = 'Users'
export const UI_NAV_LABEL_ANALYTICS = 'Analytics'
export const UI_NAV_LABEL_HEALTH = 'Health'
export const UI_NAV_LABEL_AUDIT = 'Audit'
