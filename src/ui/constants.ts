...
export const UI_TABLE_PAGE_SIZE_OPTIONS = [10, 25, 50, 100] as const
export const UI_TABLE_PAGE_SIZE_LABEL = 'Rows per page' as const
...
export const UI_CLASS_PANEL_HEADER =
  'd-flex flex-column flex-xl-row justify-content-between align-items-start align-items-xl-center gap-2'
export const UI_CLASS_PANEL_HEADER_CONTENT = 'd-flex flex-column gap-1 min-w-0'
export const UI_CLASS_PANEL_HEADER_ACTIONS = 'd-flex flex-wrap align-items-center gap-2 flex-shrink-0'
export const UI_CLASS_PANEL_TITLE = 'h5 mb-0'
export const UI_CLASS_PANEL_DESCRIPTION = 'text-muted mb-0'
export const UI_CLASS_PANEL_ACTION_BUTTON = 'text-nowrap'
...
export const UI_CLASS_AUTH_FLOW_CONTAINER = 'container py-5'
export const UI_CLASS_AUTH_FLOW_ROW = 'row justify-content-center'
export const UI_CLASS_AUTH_FLOW_CARD = 'card shadow-sm'
export const UI_CLASS_AUTH_FLOW_CARD_BODY = 'card-body p-4'
...
export const UI_CLASS_FLEX_COLUMN_GAP_XLARGE = 'd-flex flex-column gap-4'
...
export const UI_CLASS_MARGIN_END_SMALL = 'me-2'
export const UI_CLASS_TEXT_MUTED_MARGIN_BOTTOM_LARGE = 'text-muted mb-4'
export const UI_CLASS_MARGIN_TOP_MEDIUM = 'mt-3'
export const UI_CLASS_MARGIN_TOP_LARGE = 'mt-4'
export const UI_CLASS_PADDING_TOP_SMALL = 'pt-2'
export const UI_CLASS_CODE_VALUE_WRAP = 'd-inline-block w-100 text-break text-wrap'
export const UI_CLASS_BORDER_ROUNDED_PADDED = 'border rounded p-2'
export const UI_CLASS_FLEX_WRAP_GAP_SMALL = 'd-flex flex-wrap gap-2'
export const UI_CLASS_HEADING_H4_MARGIN_BOTTOM = 'h4 mb-3'
export const UI_CLASS_HEADING_H6_RESET = 'h6 mb-0'
export const UI_CLASS_BUTTON_CLOSE = 'btn-close'
...
export const UI_CLASS_AUDIT_FILTER_ACTIONS = 'col-12 d-flex flex-wrap gap-2'
...
export const UI_CLASS_TABLE_WRAPPER = 'table-responsive overflow-auto border rounded shadow-sm bg-body'
export const UI_CLASS_TABLE = 'table align-middle mb-0 w-100'
export const UI_CLASS_TABLE_HEADER_CELL = 'text-uppercase text-muted small fw-semibold text-nowrap'
export const UI_CLASS_TABLE_HEADER_CONTENT = 'd-flex align-items-center gap-2 text-nowrap'
...
export const UI_AUDIT_LOGS_PAGE_SIZE_LABEL = 'Rows per page' as const
export const UI_AUDIT_LOGS_RANGE_LABEL = 'Showing' as const
export const UI_AUDIT_LOGS_RANGE_SEPARATOR = 'to' as const
...
export const UI_AUDIT_LOGS_PANEL_CLASS = 'w-100 overflow-hidden' as const
export const UI_AUDIT_LOGS_TABLE_CLASS = 'w-100 mw-100' as const
export const UI_AUDIT_LOGS_CELL_CLASS = 'd-block text-break text-wrap' as const
export const UI_AUDIT_LOGS_METADATA_CELL_CLASS = 'd-block font-monospace small text-break text-wrap' as const
export const UI_AUDIT_LOGS_USER_AGENT_PREVIEW_LIMIT = 96 as const
export const UI_AUDIT_LOGS_DETAILS_PREVIEW_LIMIT = 160 as const
export const UI_AUDIT_LOGS_PAGE_SIZE_OPTIONS = [10, 25, 50, 100] as const
export const UI_AUDIT_LOGS_SORT_CREATED_AT = 'createdAt' as const
export const UI_AUDIT_LOGS_SORT_ADMIN = 'adminUsername' as const
export const UI_AUDIT_LOGS_SORT_ACTION = 'action' as const
export const UI_AUDIT_LOGS_SORT_RESOURCE_TYPE = 'resourceType' as const
export const UI_AUDIT_LOGS_SORT_RESOURCE_ID = 'resourceId' as const
export const UI_AUDIT_LOGS_SORT_IP = 'ipAddress' as const
...
export const UI_RELEASE_FORM_ERROR_FALLBACK = 'Release upload failed. Please try again.' as const
export const UI_RELEASE_FORM_ERROR_TIMEOUT_HINT =
  'Upload may still complete in the background. Refresh Releases before retrying this version.' as const
...
export const UI_TENANT_FILTER_LABEL = 'Tenant' as const
export const UI_TENANT_FILTER_ALL = 'All tenants' as const
export const UI_RELEASE_TENANT_FILTER_LABEL = UI_TENANT_FILTER_LABEL
export const UI_RELEASE_TENANT_FILTER_ALL = UI_TENANT_FILTER_ALL
export const UI_RELEASE_CHANNEL_FILTER_LABEL = 'Channel' as const
export const UI_RELEASE_ACTION_DOWNLOAD = 'Download' as const
export const UI_RELEASE_ACTION_DOWNLOADING = 'Downloading…' as const
export const UI_RELEASE_DOWNLOAD_ERROR_MISSING = 'Release file is missing from storage.' as const
export const UI_RELEASE_DOWNLOAD_ERROR_GENERIC = 'Unable to download this release right now.' as const
...
export const UI_RELEASE_COLUMN_ID_VERSION = 'version' as const
export const UI_RELEASE_COLUMN_ID_FILE = 'file' as const
export const UI_RELEASE_COLUMN_ID_SIZE = 'size' as const
export const UI_RELEASE_COLUMN_ID_CREATED = 'createdAt' as const
export const UI_RELEASE_COLUMN_ID_STATUS = 'status' as const
export const UI_RELEASE_COLUMN_ID_ACTIONS = 'actions' as const
export const UI_RELEASE_BYTES_UNIT = 'B' as const
...
export const UI_AGENT_SERVICE_ACCOUNT_BUTTON_CREATE = 'Create Agent Account' as const
...
export const UI_AGENT_SERVICE_ACCOUNT_MODAL_TITLE = 'Create Agent Service Account' as const
export const UI_AGENT_SERVICE_ACCOUNT_FIELD_LABEL_NAME = 'Account name' as const
export const UI_AGENT_SERVICE_ACCOUNT_FIELD_LABEL_DESCRIPTION = 'Description' as const
export const UI_AGENT_SERVICE_ACCOUNT_FIELD_LABEL_SCOPE_MODE = 'Scope mode' as const
export const UI_AGENT_SERVICE_ACCOUNT_SCOPE_MODE_SYSTEM = 'SYSTEM' as const
export const UI_AGENT_SERVICE_ACCOUNT_SCOPE_MODE_VENDOR = 'VENDOR' as const
...
export const UI_AGENT_SERVICE_ACCOUNT_ACTION_VIEW_CREDENTIALS = 'Credential history' as const
export const UI_AGENT_SERVICE_ACCOUNT_ACTION_EDIT = 'Edit account' as const
...
export const UI_AGENT_SERVICE_ACCOUNT_STATUS_ACTIVE = 'ACTIVE' as const
export const UI_AGENT_SERVICE_ACCOUNT_STATUS_DISABLED = 'DISABLED' as const
export const UI_AGENT_SERVICE_ACCOUNT_STATUS_LABEL_ACTIVE = 'Active' as const
export const UI_AGENT_SERVICE_ACCOUNT_STATUS_LABEL_DISABLED = 'Disabled' as const
export const UI_AGENT_SERVICE_ACCOUNT_SUBMIT_UPDATE = 'Save changes' as const
...
export const UI_AGENT_SERVICE_ACCOUNT_TOAST_REVOKE_ERROR = 'Unable to revoke credential' as const
export const UI_AGENT_SERVICE_ACCOUNT_TOAST_UPDATE_SUCCESS = 'Agent account updated successfully' as const
export const UI_AGENT_SERVICE_ACCOUNT_TOAST_UPDATE_ERROR = 'Unable to update agent account' as const
...
export const UI_AGENT_SERVICE_ACCOUNT_CREDENTIAL_COLUMN_NAME = 'Credential' as const
export const UI_AGENT_SERVICE_ACCOUNT_CREDENTIAL_COLUMN_CLIENT_ID = 'Client ID' as const
export const UI_AGENT_SERVICE_ACCOUNT_CREDENTIAL_COLUMN_SCOPES = 'Scopes' as const
export const UI_AGENT_SERVICE_ACCOUNT_CREDENTIAL_COLUMN_CREATED = 'Created' as const
export const UI_AGENT_SERVICE_ACCOUNT_CREDENTIAL_COLUMN_EXPIRES = 'Expires' as const
export const UI_AGENT_SERVICE_ACCOUNT_CREDENTIAL_COLUMN_REVOKED = 'Revoked' as const
export const UI_AGENT_SERVICE_ACCOUNT_CREDENTIAL_COLUMN_ACTIONS = 'Actions' as const
export const UI_AGENT_SERVICE_ACCOUNT_CREDENTIAL_EMPTY_STATE = 'No credentials issued yet.' as const
export const UI_AGENT_SERVICE_ACCOUNT_CREDENTIAL_FILTER_LABEL = 'Credential status' as const
export const UI_AGENT_SERVICE_ACCOUNT_CREDENTIAL_FILTER_ALL = 'All credentials' as const
export const UI_AGENT_SERVICE_ACCOUNT_CREDENTIAL_FILTER_ACTIVE = 'Active only' as const
export const UI_AGENT_SERVICE_ACCOUNT_CREDENTIAL_FILTER_REVOKED = 'Revoked only' as const
export const UI_AGENT_SERVICE_ACCOUNT_CREDENTIAL_FILTER_EXPIRED = 'Expired only' as const
export const UI_AGENT_SERVICE_ACCOUNT_CREDENTIAL_FILTER_VALUE_ALL = 'ALL' as const
export const UI_AGENT_SERVICE_ACCOUNT_CREDENTIAL_FILTER_VALUE_ACTIVE = 'ACTIVE' as const
export const UI_AGENT_SERVICE_ACCOUNT_CREDENTIAL_FILTER_VALUE_REVOKED = 'REVOKED' as const
export const UI_AGENT_SERVICE_ACCOUNT_CREDENTIAL_FILTER_VALUE_EXPIRED = 'EXPIRED' as const
export const UI_AGENT_SERVICE_ACCOUNT_CREDENTIAL_SEARCH_LABEL = 'Search credentials' as const
export const UI_AGENT_SERVICE_ACCOUNT_CREDENTIAL_SEARCH_PLACEHOLDER = 'Search by credential name or client ID' as const
export const UI_AGENT_SERVICE_ACCOUNT_CREDENTIAL_SORT_LABEL = 'Sort by created time' as const
export const UI_AGENT_SERVICE_ACCOUNT_CREDENTIAL_SORT_NEWEST = 'Newest first' as const
export const UI_AGENT_SERVICE_ACCOUNT_CREDENTIAL_SORT_OLDEST = 'Oldest first' as const
export const UI_AGENT_SERVICE_ACCOUNT_CREDENTIAL_SORT_VALUE_NEWEST = 'NEWEST' as const
export const UI_AGENT_SERVICE_ACCOUNT_CREDENTIAL_SORT_VALUE_OLDEST = 'OLDEST' as const
...
export const UI_PRODUCT_BUTTON_DELETE = 'Deactivate Product' as const
...
export const UI_PRODUCT_BUTTON_PROTECTION_KEY = 'Protection Key' as const
export const UI_PRODUCT_BUTTON_BUILD_TOKENS = 'Build Tokens' as const
...
export const UI_PRODUCT_FIELD_REQUIRES_LICENSE = 'requires_license' as const
export const UI_PRODUCT_FORM_LABEL_REQUIRES_LICENSE = 'Requires license key' as const
export const UI_PRODUCT_FORM_HELPER_REQUIRES_LICENSE =
  'Uncheck for a free product — updates are delivered without a license key.' as const
export const UI_PRODUCT_REQUIRES_LICENSE_DEFAULT = true as const
export const UI_PRODUCT_ACTION_EDIT = 'Edit Product' as const
export const UI_PRODUCT_ACTION_DELETE = 'Deactivate Product' as const
...
export const UI_PRODUCT_ACTION_PROTECTION_KEY = 'Protection Key' as const
export const UI_PRODUCT_ACTION_BUILD_TOKENS = 'Build Tokens' as const
export const UI_PRODUCT_PROTECTION_KEY_MODAL_TITLE = 'Protection Signing Key' as const
export const UI_PRODUCT_PROTECTION_KEY_LABEL_PRODUCT = 'Product slug' as const
export const UI_PRODUCT_PROTECTION_KEY_LABEL_SIGNING_KEY_ID = 'Signing key ID' as const
export const UI_PRODUCT_PROTECTION_KEY_LABEL_PUBLIC_KEY = 'Public key' as const
export const UI_PRODUCT_PROTECTION_KEY_LOADING = 'Loading protection signing key…' as const
export const UI_PRODUCT_PROTECTION_KEY_ERROR = 'Unable to load protection signing key.' as const
export const UI_PRODUCT_PROTECTION_KEY_CLOSE = 'Close' as const
export const UI_PRODUCT_BUILD_TOKENS_MODAL_TITLE = 'Protection Build Tokens' as const
export const UI_PRODUCT_BUILD_TOKENS_LOADING = 'Loading protection build tokens…' as const
export const UI_PRODUCT_BUILD_TOKENS_ERROR = 'Unable to load protection build tokens.' as const
export const UI_PRODUCT_BUILD_TOKENS_CLOSE = 'Close' as const
...
export const UI_PRODUCT_BUILD_TOKENS_REVOKING = 'Revoking…' as const
export const UI_PRODUCT_BUILD_TOKENS_LABEL_PREFIX = 'Prefix' as const
export const UI_PRODUCT_BUILD_TOKENS_LABEL_STATUS = 'Status' as const
export const UI_PRODUCT_BUILD_TOKENS_LABEL_EXPIRES = 'Expires' as const
export const UI_PRODUCT_BUILD_TOKENS_LABEL_LAST_USED = 'Last used' as const
export const UI_PRODUCT_BUILD_TOKENS_LABEL_ISSUED_TOKEN = 'Issued token' as const
export const UI_PRODUCT_BUILD_TOKENS_LABEL_USAGE_NOTE = 'Usage note' as const
export const UI_PRODUCT_BUILD_TOKENS_LABEL_RELEASE_ENDPOINT = 'Release endpoint' as const
export const UI_PRODUCT_BUILD_TOKENS_STATUS_ACTIVE = 'Active' as const
export const UI_PRODUCT_BUILD_TOKENS_STATUS_REVOKED = 'Revoked' as const
export const UI_PRODUCT_BUILD_TOKENS_STATUS_EXPIRED = 'Expired' as const
export const UI_PRODUCT_BUILD_TOKEN_DEFAULT_EXPIRY_DAYS = 30 as const
...
export const UI_PRODUCT_COLUMN_ID_WOO_SYNC = 'product-column-woo-sync' as const
export const UI_PRODUCT_COLUMN_ID_LICENSING = 'product-column-licensing' as const
...
export const UI_PRODUCT_COLUMN_HEADER_WOO_SYNC = 'Woo sync' as const
export const UI_PRODUCT_COLUMN_HEADER_LICENSING = 'Licensing' as const
...
export const UI_PRODUCT_STATUS_SUSPENDED = 'Deactivated' as const
export const UI_PRODUCT_WOO_SYNC_ENABLED = 'Enabled' as const
export const UI_PRODUCT_WOO_SYNC_DISABLED = 'Disabled' as const
export const UI_PRODUCT_LICENSING_LICENSED = 'Licensed' as const
export const UI_PRODUCT_LICENSING_FREE = 'Free' as const
export const UI_PRODUCT_FILTER_VALUE_ACTIVE = 'true' as const
export const UI_PRODUCT_FILTER_VALUE_INACTIVE = 'false' as const
...
export const UI_PRODUCT_TOAST_DELETE_SUCCESS = 'Product deactivated successfully' as const
...
export const UI_PRODUCT_CONFIRM_DELETE_TITLE = 'Deactivate product?' as const
export const UI_PRODUCT_CONFIRM_DELETE_BODY =
  'Deactivating a product disables issuance and access paths. You can reactivate it later.' as const
export const UI_PRODUCT_CONFIRM_DELETE_CONFIRM = 'Deactivate product' as const
...
export const UI_PRODUCT_TIER_COLUMN_HEADER_STATUS = 'Status' as const
...
export const UI_PRODUCT_TIER_STATUS_ACTIVE = 'Active' as const
export const UI_PRODUCT_TIER_STATUS_DEACTIVATED = 'Deactivated' as const
export const UI_PRODUCT_TIER_FILTER_PLACEHOLDER = 'All statuses' as const
...
export const UI_LICENSE_CONFIRM_DELETE_BODY =
  'Soft deleting a license revokes it and removes it from the default license list. This action cannot be undone.' as const
...
export const UI_CLASS_SIDE_PANEL_PLACEMENT_START = 'start-0'
export const UI_CLASS_SIDE_PANEL_PLACEMENT_END = 'end-0'
