...
import {
  ...
  UI_LICENSE_TOAST_REVOKE_SUCCESS,
...
type LicenseCrudKind = CrudKind | 'revoke'
...
export const notifyLicenseSuccess = (bus: NotificationBus, kind: LicenseCrudKind) =>
